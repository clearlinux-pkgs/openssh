...
Version  : 10.0p1
Release  : 131
URL      : https://openbsd.cs.toronto.edu/pub/OpenBSD/OpenSSH/portable/openssh-10.0p1.tar.gz
Source0  : https://openbsd.cs.toronto.edu/pub/OpenBSD/OpenSSH/portable/openssh-10.0p1.tar.gz
Source1  : openssh.tmpfiles
Source2  : sshd-keygen.service
Source3  : sshd.service
Source4  : sshd.socket
Source5  : sshd@.service
Source6  : https://openbsd.cs.toronto.edu/pub/OpenBSD/OpenSSH/portable/openssh-10.0p1.tar.gz.asc
...
%setup -q -n openssh-10.0p1
cd %{_builddir}/openssh-10.0p1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744289912
...
cp %{_builddir}/openssh-%{version}/LICENCE %{buildroot}/usr/share/package-licenses/openssh/03619c16f914530f2d80d3bb4f2d9091f95fee20 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/openssh/03619c16f914530f2d80d3bb4f2d9091f95fee20
