...
Source6  : https://openbsd.cs.toronto.edu/pub/OpenBSD/OpenSSH/portable/openssh-9.4p1.tar.gz.asc
...
%prep
%setup -q -n openssh-9.4p1
cd %{_builddir}/openssh-9.4p1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
