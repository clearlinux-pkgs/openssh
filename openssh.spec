...
Source0  : https://openbsd.cs.toronto.edu/pub/OpenBSD/OpenSSH/portable/openssh-8.9p1.tar.gz
Source1  : openssh.tmpfiles
Source2  : sshd-keygen.service
Source3  : sshd.service
Source4  : sshd.socket
Source5  : sshd@.service
Source6  : https://openbsd.cs.toronto.edu/pub/OpenBSD/OpenSSH/portable/openssh-8.9p1.tar.gz.asc
...
%prep
%setup -q -n openssh-8.9p1
cd %{_builddir}/openssh-8.9p1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645655436
...
cp %{_builddir}/openssh-8.9p1/LICENCE %{buildroot}/usr/share/package-licenses/openssh/fc6deda3f77a10873cdc1d57604d54f7c7bc711d
%make_install
